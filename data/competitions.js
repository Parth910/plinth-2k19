module.exports.competitions = {
    competitions: [
        ...
        //                     +"</p>"
        //                         +"<p>"
        //                         +"<h5>Why should you attend it?</h5>"
        //                         +"<p>"
        ...
        
        {
            ...
            synopsis: "<p>"
                        ...
                        +"</p>",
            rules: "<p style='font-family:Roboto-Black'>"
                        +"<h5>Robot Specification</h5>"
                        +"<ol>"
        ...
        },
        {
            ...
            rules: "<p>"
                        ...
                        +"<h5>Violation And Disqualification</h5>"
                        +"<ol>"
        ...
        },
        {
            ...
            eventDescription: "<p>"
                                    ...
                                    +"<ol>"
                                        ...
                                        +"</li>"                                       
                                    +"</ol>"
                                    +"<h5>Spot ​Landing:​​ ​(Max​ ​Points​ ​50,​ ​30,​ ​20)</h5>"
                                    +"<ol>"
                                    ...
                                    +"</ol>"
                                    +"<h5>Materials​​ ​​and​​ ​​services​​ to be ​​provided"
                                    +"<ol>"

...
function mediaQueries(A, e, t) {
    var n = function (A) {
        A.matches ? e() : t()
    };
    mql = window.matchMedia("all and (max-width: " + A + "px)"), n(mql), mql.addListener(n)
}
$(function () {
    var n, i;
    document.body.classList.add("page-main"), (isMob = function () {
        var A, e = (A = navigator.userAgent || navigator.vendor || window.opera, !(!/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(A) && !/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(A.substr(0, 4))));
        return e && $("body").addClass("mob"), e
    })(), /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && $("body").addClass("ios"), !!navigator.platform.match(/(Mac|iPhone|iPod|iPad)/i) && $("body").addClass("osx"), !1 === function () {
        var A = window.navigator.userAgent,
            e = A.indexOf("MSIE ");
        if (0 < e) return parseInt(A.substring(e + 5, A.indexOf(".", e)), 10);
        if (0 < A.indexOf("Trident/")) {
            var t = A.indexOf("rv:");
            return parseInt(A.substring(t + 3, A.indexOf(".", t)), 10)
        }
        var n = A.indexOf("Edge/");
        return 0 < n && parseInt(A.substring(n + 5, A.indexOf(".", n)), 10)
    }() ? $("body").removeClass("ie") : $("body").addClass("ie"), $(".hamburger, .menu-list-item").click(function () {
        if ($(this).hasClass("menu-list-item")) {
            var A = $(this).find("a").attr("href");
            if ("" === A[0] && (A = A.slice(1)), 0 !== $(A).length) {
                event.preventDefault();
                var e = $(A).offset().top + parseInt($(A).css("padding-top"));
                $("html, body").animate({
                    scrollTop: e - 5
                }, 1e3)
        ...
        } else A.preventDefault(), $("#sections, .footer").toggleClass("is-hidden"), TweenMax.to(controls, .4, {
            tube: 40,
            ease: Power2.easeInOut,
            onUpdate: function () {
                controls.redraw()
    ...
    }), n = !0, i = 100, $(".news-btn-prev").on("click", function () {
        var A = new TimelineMax,
            e = Power2.easeInOut;
        n = !0, i = 100, A.staggerTo(".news__img", .4, {
            ease: e,
            x: "0%"
        ...
        var A = new TimelineMax,
            e = Power2.easeInOut,
            t = $(".news__img:last");
        if (0 < $(window).width() - (t.offset().left + t.outerWidth())) return !1;
        n ? A.to(".news__header", .4, {
            ease: e,
            y: "-200%"
        ...
        }, .05, "-=0.4") : (A.staggerTo(".news__img", .4, {
            ease: e,
            x: "-" + (126 + i) + "%"
        }, .05), i += 80)
    }), $(".main__btn").on("click", function () {
        var A = "#request",
            e = $(A).offset().top + parseInt($(A).css("padding-top"));
        $("html, body").animate({
            scrollTop: e
        }, 1e3)
    }), $(".prize-header").height($(".prize-header").height() - $(".prize-header__text").height()), $(".versus__header .section-header--up").hide();
    var A = function () {
        var A = $(".main__header").outerWidth();
        $(".main__year").width(A);
        var e = $(".cover--stages .cover__inner").offset().top,
            t = $(".prize:first").offset().left;
        $(".cover--stages .cover__inner").offset({
            top: e,
            left: t
        });
        var n = $(".news").offset().top,
            i = +$(".example-wrap").css("padding-left").split("px")[0],
            s = $(".example").offset().left - i;
        $(".news").offset({
            top: n,
            left: s
        });
        var o = $(".header__logo").offset().left;
        $(".fixed-nav").offset({
            top: "50%",
            left: o
        });
        var a = $("#chat .fluid--px").offset().top;
        $(".int-canvas-wrap--chat").offset({
            top: a,
            left: 0
        });
        var r = $(".news-buttons").offset().top,
            c = $(".news__images").offset().left;
        c > window.innerWidth && (c -= $(".news__images").outerWidth()), $(".news-buttons").offset({
            top: r,
            left: c
        }), $(".hud-timer__inner").width($(".hud__deadline-date").width())
    };
    A(), $(window).on("resize", A), $(function () {
        $(".request__input, .request__textarea").on("focus", function () {
            $(".request__input, .request__textarea").each(function (A, e) {
                0 === $(e).val().length && $(e).parent().removeClass("clicked")
    ...
    ! function A() {
        var e = new Date,
            t = $("#hidden_date_final").val(),
            n = new Date(t.replace(" ", "T")),
            i = new Date(n);

        function s(A, e) {
            this.days = null, this.hours = null, this.minutes = null, this.seconds = null, this.date1 = A, this.date2 = e, this.init()
        }
        s.prototype.init = function () {
            var A = new function (A) {
                var e, t, n, i;
                i = Math.floor(A / 1e3), n = Math.floor(i / 60), i %= 60, t = Math.floor(n / 60), n %= 60, e = Math.floor(t / 24), t %= 24, this.days = e, this.hours = t, this.minutes = n, this.seconds = i
            }(this.date1 - this.date2);
            this.days = A.days, this.hours = A.hours, this.minutes = A.minutes, this.seconds = A.seconds
        }, Date.diff = function (A, e) {
            return new s(A, e)
        }, Date.prototype.diff = function (A) {
            return new s(this, A)
        };
        var o = Date.diff(i, e);
        $(".hud-timer__cell--days span").text(o.days), $(".hud-timer__cell--hours span").text(o.hours), $(".hud-timer__cell--mins span").text(o.minutes), window.setTimeout(function () {
            A()
        }, 6e4)
    }()
}), $(function () {
    ...
    e.setClearColor(0, 0), e.setSize(window.innerWidth, window.innerHeight), e.shadowMapEnabled = !0, $(window).on("resize", function () {
        e.setSize(window.innerWidth, window.innerHeight), camera.aspect = window.innerWidth / window.innerHeight, camera.updateProjectionMatrix()
    }), camera.position.x = -60, camera.position.y = 60, camera.position.z = 60, camera.lookAt(new THREE.Vector3(0, 0, 0)), $("#webgl-output").append(e.domElement);
    var a, A, t = 0;
    (controls = new function () {
        this.radius = 1, this.tube = 1, this.radialSegments = 350, isMob() ? this.radialSegments = 300 : this.radialSegments = 350, this.tubularSegments = 12, this.p = 5, this.q = 4, this.heightScale = 4, this.asParticles = !0, this.rotate = !0, Power3.easeInOut, this.redraw = function () {
            a && o.remove(a);
            var A, e, t, n, i, s = new THREE.TorusKnotGeometry(controls.radius, controls.tube, Math.round(controls.radialSegments), Math.round(controls.tubularSegments), Math.round(controls.p), Math.round(controls.q), controls.heightScale);
            controls.asParticles ? (t = s, n = new THREE.ParticleBasicMaterial({
                color: 16777215,
                size: .5,
                transparent: !0,
                ...
                map: function () {
                    ...
                    var e = A.getContext("2d"),
                        t = e.createRadialGradient(A.width / 2, A.height / 2, 0, A.width / 2, A.height / 2, A.width / 2);
                    t.addColorStop(1, "rgba(58,54,197,1)"), t.addColorStop(1, "rgba(0,0,0,0)"), e.fillStyle = t, e.fillRect(0, 0, A.width, A.height);
                    var n = new THREE.Texture(A);
                    return n.needsUpdate = !0, n
                }()
            }), (i = new THREE.ParticleSystem(t, n)).sortParticles = !0, a = i) : (A = s, (e = new THREE.MeshNormalMaterial({})).side = THREE.DoubleSide, a = THREE.SceneUtils.createMultiMaterialObject(A, [e])), o.add(a)
        }, this.start = function () {
            controls.tube, controls.radius = 1, isMob() ? (new TimelineMax).to(controls, 3, {
                tube: 30,
                ease: Power4.easeOut,
                onUpdate: function () {
                    controls.redraw()
                }
            }) : ($(".menu-list-item a, .section-header--up, .main__year span, .main__header, .section-header, .news__header").css("opacity", 1), $(".menu-list-item a, .section-header--up, .main__year span, .main__header, .section-header, .cover__header, .news__header").addClass("js-splitme"), document.querySelectorAll(".js-splitme").forEach(function (A) {
                A.outerHTML = Splitter(A.outerHTML, '<span class="letter">$</span>')
            }), function () {
                ...
                $(".section").each(function (e, A) {
                    var t = $(A);
                    new ScrollMagic.Scene({
                        offset: t.offset().top - $(".section-padding").height() - 400,
                        triggerHook: "onEnter",
                        duration: t.height()
                    }).on("enter", function () {
                        Power3.easeInOut;
                        ...
                        switch ($(".fixed-nav__list-item").removeClass("active"), $(".fixed-nav__list-item:eq(" + e + ")").addClass("active"), 0 !== e && (A(), $(".section").addClass("darken")), 6 !== e && ($(".fixed-logo .header__logo").html('<img class="rimg" src="../media/logo.svg" alt="Plinth">'), $(".fixed-nav, .hamburger").removeClass("dark")), e) {
                            case 0:
                                controls.prestart(), mediaQueries(1059, A, function () {
                ...
                }).on("enter leave", function (A) {
                    "enter" === A.type ? TweenMax.to(controls, 1.5, {
                        radius: 14,
                        onUpdate: function () {
                            controls.redraw()
                        },
                ...
                var A = document.querySelectorAll(".section-header");
                $(A).each(function (A, e) {
                    var t = $(e).closest(".section");
                    new ScrollMagic.Scene({
                        offset: t.offset().top - window.innerHeight / 1.55,
                        triggerHook: "onEnter"
                    }).on("enter", function () {
                        (new TimelineMax).staggerTo(t.find(".section-header .letter"), .5, {
                            x: "0%",
                            opacity: 1,
                            onComplete: function () {
                                $(t).hasClass("section-prize") || t.find(".section-header").addClass("header-glitch")
                            }
                        }, .025).staggerTo(t.find(".section-header--up .letter"), .8, {
                            x: "0%",
                            opacity: 1
                        }, .05, "-=0.8").to(t.find(".section-description"), .6, {
                            ease: Power1.easeInOut,
                            y: "0%",
                            opacity: 1
                        }, "-=1")
                    }).addTo(n)
                }), isMob() || $(".example-wrap").each(function (A, e) {
                    new ScrollMagic.Scene({
                        triggerElement: e,
                        triggerHook: "onEnter",
                        offset: -window.innerHeight / 1.5
                    }).setTween((new TimelineMax).fromTo($(e).find(".example"), 1, {
                        y: "15%"
                    }, {
                        y: "0%"
                    }, "sync").to(e, 1, {
                    ...
                    y: "-10%"
                }, "sync")).addTo(n)), setTimeout(function () {
                    $(".cover__header").each(function (A, e) {
                        new ScrollMagic.Scene({
                            triggerElement: e.parentNode,
                            triggerHook: "onEnter",
                            offset: -window.innerHeight
                        }).on("enter", function () {
                            (new TimelineMax).staggerTo($(e).find(".letter"), .5, {
                                x: "0%",
                                opacity: 1
                            }, .025).staggerFromTo($(e).parent().find(".list__item"), .5, {
                                ease: Power1.easeInOut,
                                y: "60%",
                                opacity: 0
                            }, {
                ...
                var e = (new TimelineMax).staggerTo(".prize__ring", 2, {
                    opacity: 1,
                    onStart: function () {
                        this.target.classList.add("anim");
                        var A = $(this.target.parentNode);
                        (new TimelineMax).to(A.find(".prize__eth"), .4, {
                            y: "0%",
                            opacity: 1
                        }).to(A.find(".prize__rub"), .4, {
                            y: "0%",
                            opacity: 1
                        })
                    }
                ...
                var t = $(".news").closest(".section");
                new ScrollMagic.Scene({
                    offset: -window.innerHeight / 1.2,
                    triggerElement: ".news",
                    triggerHook: "onEnter"
                }).on("enter", function () {
                    (new TimelineMax).staggerTo(t.find(".news__header .letter"), .5, {
                        x: "0%",
                        opacity: 1,
                        onComplete: function () {
                            $(".news__header").addClass("header-glitch")
                        }
                    }, .025).to(t.find(".news__desc"), .9, {
                        ease: Power1.easeInOut,
                        y: "0%",
                        opacity: 1
        ...
        controls.rotate && (a.rotation.y = t += .001), TweenMax.ticker.addEventListener("tick", A), e.render(o, camera)
    }, isMob() && (A = new ScrollMagic.Controller({
        globalSceneOptions: {
            triggerHook: "onLeave"
        }
    }), $(".section-main"), new ScrollMagic.Scene({
        ...
        return function () {
            ...
            return new Promise(function (s, o) {
                return function e(A, t) {
                    ...
                    if (!n.done) return Promise.resolve(i).then(function (A) {
                        e("next", A)
                    }, function (A) {
                        e("throw", A)
                    });
    ...
    var A = function (A) {
        function i(A) {
            ...
            return n.resize = i.debounce(s(regeneratorRuntime.mark(function A() {
            ...
            }, A), n.polygon = n.options.polygon.replace(/\s/g, "").split(",").map(function (A) {
                var e = 0 | A;
                return e > n.options.borderWidth ? e - n.options.borderWidth / 2 : e
            }), n.offset = 20, n.animate = !1, e = n.createCanvas(), o(n, e)
        }
        var e;
        return function (A, e) {
        ...
        }(i, PIXI.Application), t(i, [{
            key: "createCanvas",
            value: (e = s(regeneratorRuntime.mark(function A() {
                var e;
                return regeneratorRuntime.wrap(function (A) {
                    for (;;) switch (A.prev = A.next) {
                        case 0:
                           ...
                           this.options.element.appendChild(this.view), 
                            ...
                            this.stage.addChild(this.container), A.next = 7;
                        case 7:
                            e = A.sent, this.waves = new PIXI.Sprite(e), this.noiseSprite = PIXI.Sprite.fromImage(this.options.displacementMap), this.setSize(), this.addGraphics(), this.bindEvents(), this.render(), $(this.options.element).hasClass("main__btn") || this.options.element.classList.add("canvas-ready");
                        case 15:
                        case "end":
                            return A.stop()
                    }
            ...
            value: function () {
                ...
                A.beginFill(0, 0), A.drawRect(0, 0, this.width, this.width), this.container.addChild(A), this.container.addChild(this.getPolygon()), this.setMask(), this.addFilter()
            }
        }, {
            key: "setMask",
            value: function () {
                var A = this.getPolygon();
                this.stage.addChild(A), this.container.mask = A
            }
        }, {
            key: "drawWaves",
            value: function () {
            ...
            key: "setSize",
            value: function () {
                var A = this.options.element.offsetWidth,
                    e = this.options.element.offsetHeight;
                return this.width = A + 2 * this.offset, this.height = e + 2 * this.offset, this.oldWidth !== this.width && (this.renderer.resize(this.width, this.height), this.oldWidth = this.width, !0)
            }
        }, {
            key: "loadTexture",
            value: function (e) {
                return new Promise(function (t) {
                    ...
                    A.add("waves", e), A.load(function (A, e) {
                        return t(e.waves.texture)
                    })
                })
            }
        }, {
            ...
            value: function (A) {
                var e = this.polygon,
                    ...
                    i = this.height - 2 * this.offset - this.options.borderWidth;
                t.position.x = this.offset + this.options.borderWidth / 2, t.position.y = this.offset + this.options.borderWidth / 2;
                var s = [
                    [0, e[0]],
                    [e[0], 0],
                    [n - e[1], 0],
                ...
                t.lineStyle(this.options.borderWidth, this.options.borderColor), t.beginFill(this.options.backgroundColor, A ? 1 - this.options.backgroundAlpha : 0);
                for (var o = 0, a = []; o < s.length; o++) a.length && a[0] === s[o][0] && a[1] === s[o][1] || (0 !== o ? (a = s[o], t.lineTo(s[o][0], s[o][1])) : (t.moveTo(s[o][0], s[o][1]), a = s[o]));
                return t.endFill(), t
            }
        }], [{
            key: "debounce",
    ...
    if (!isMob()) {
        ...
        TweenMax.set([A], {
            ...
            var e = $(this),
                t = A.pageX / e.width() * 100 - 100,
                n = (A.pageY - $(this).offset().top) / e.height() * 100 - 100;
            TweenMax.to(e, 2, {
                rotationY: .03 * t,
                rotationX: -.03 * n,
    ...
    function A(A) {
        this.density = A.density, this.drawDistance = 28, this.baseRadius = 2, this.maxLineThickness = 1, this.reactionSensitivity = 2, this.lineThickness = 1, this.points = [], this.mouse = {
            x: -1e3,
            y: -1e3,
            down: !1
        }, this.animation = null, this.canvas = A.canvas, this.context = null, this.imageInput = null, this.bgImage = null, this.bgCanvas = null, this.bgContext = null, this.bgContextPixelData = null, this.imgData = A.data
    }
    A.prototype.init = function () {
        ...
        this.canvas.addEventListener("mousemove", function (A) {
            TweenMax.ticker.addEventListener("tick", e.draw, e), e.mouse.x = A.offsetX || A.layerX - e.canvas.offsetLeft, e.mouse.y = A.offsetY || A.layerY - e.canvas.offsetTop
        }), this.canvas.addEventListener("mouseout", function (A) {
            e.mouse.x = -1e3, e.mouse.y = -1e3, e.mouse.down = !1, setTimeout(function () {
                TweenMax.ticker.removeEventListener("tick", e.draw)
            }, 1200)
        }), this.loadData(this.imgData)
    }, A.prototype.preparePoints = function () {
        var A, e;
        this.points = [];
        var t = this.bgContextPixelData.data;
        for (A = 0; A < this.canvas.height; A += this.density)
            for (e = 0; e < this.canvas.width; e += this.density) {
                var n = 4 * (e + A * this.bgContextPixelData.width);
                if (!(200 < t[n] && 200 < t[n + 1] && 200 < t[n + 2] || 0 === t[n + 3])) {
                    var i = "rgba(" + t[n] + "," + t[n + 1] + "," + t[n + 2] + ",1)";
                    this.points.push({
                        x: e,
                        y: A,
                        originalX: e,
    ...
    }, A.prototype.updatePoints = function () {
        var A, e, t, n;
        for (A = 0; A < this.points.length; A++) e = this.points[A], t = Math.atan2(e.y - this.mouse.y, e.x - this.mouse.x), n = this.mouse.down ? 200 * this.reactionSensitivity / Math.sqrt((this.mouse.x - e.x) * (this.mouse.x - e.x) + (this.mouse.y - e.y) * (this.mouse.y - e.y)) : 100 * this.reactionSensitivity / Math.sqrt((this.mouse.x - e.x) * (this.mouse.x - e.x) + (this.mouse.y - e.y) * (this.mouse.y - e.y)), e.x += Math.cos(t) * n + .05 * (e.originalX - e.x), e.y += Math.sin(t) * n + .05 * (e.originalY - e.y)
    }, A.prototype.drawLines = function () {
        var A, e, t, n, i;
        for (A = 0; A < this.points.length; A++)
            for (t = this.points[A], this.context.fillStyle = t.color, this.context.strokeStyle = t.color, e = 0; e < this.points.length; e++)(n = this.points[e]) != t && (i = Math.sqrt((n.x - t.x) * (n.x - t.x) + (n.y - t.y) * (n.y - t.y))) <= this.drawDistance && (this.context.lineWidth = (1 - i / this.drawDistance) * this.maxLineThickness * this.lineThickness, this.context.beginPath(), this.context.moveTo(t.x, t.y), this.context.lineTo(n.x, n.y), this.context.stroke())
    }, A.prototype.drawPoints = function () {
        var A, e;
        for (A = 0; A < this.points.length; A++) e = this.points[A], this.context.fillStyle = e.color, this.context.strokeStyle = e.color, this.context.beginPath(), this.context.arc(e.x, e.y, this.baseRadius, 0, 2 * Math.PI, !0), this.context.closePath(), this.context.fill()
    }, A.prototype.clear = function () {
        this.canvas.width = this.canvas.width
    }, A.prototype.draw = function () {
        this.clear(), this.updatePoints(), this.drawLines(), this.drawPoints()
    }, A.prototype.drawImageToBackground = function () {
        var A, e;
        if (this.bgCanvas = document.createElement("canvas"), this.bgCanvas.width = this.canvas.width, this.bgCanvas.height = this.canvas.height, this.bgImage.width > this.bgCanvas.width - 100 || this.bgImage.height > this.bgCanvas.height - 100) {
            var t = Math.max(this.bgImage.width / (this.bgCanvas.width - 100), this.bgImage.height / (this.bgCanvas.height - 100));
            A = this.bgImage.width / t, e = this.bgImage.height / t
        } else A = this.bgImage.width, e = this.bgImage.height;
        this.bgContext = this.bgCanvas.getContext("2d"), this.bgContext.drawImage(this.bgImage, Math.floor((this.canvas.width - A) / 2), Math.floor((this.canvas.height - e) / 2), A, e), this.bgContextPixelData = this.bgContext.getImageData(0, 0, this.bgCanvas.width, this.bgCanvas.height), this.preparePoints(), this.draw()
    }, A.prototype.loadData = function (A) {
        this.bgImage = new Image, this.bgImage.src = A;
        var e = this;
        this.bgImage.onload = function () {
            e.drawImageToBackground()
        }
    }, A.prototype.mouseDown = function (A) {
        this.mouse.down = !0
    }, A.prototype.mouseUp = function (A) {
        this.mouse.down = !1
    }, A.prototype.mouseMove = function (A) {
        this.mouse.x = A.offsetX || A.layerX - this.canvas.offsetLeft, this.mouse.y = A.offsetY || A.layerY - this.canvas.offsetTop
    }, A.prototype.mouseOut = function (A) {
    ...
    e.prototype.layout = function () {
        for (var A = 0; A < 5; A++) this.DOM.slideImg.innerHTML += "<div class='glitch__img' style='background-image:" + this.DOM.slideImg.style.backgroundImage + "'></div>";
        ...
        var t = this;
        this.DOM.slides.forEach(function (A) {
            t.slides.push(new e(A))
        }), this.DOM.slides.forEach(function (A, e) {
            t.slides[e].DOM.slideImg.addEventListener("mouseover", function () {
                t.slides[e].DOM.slideImg.classList.add("glitch--animate")
            }), t.slides[e].DOM.slideImg.addEventListener("mouseout", function () {
                t.slides[e].DOM.slideImg.classList.remove("glitch--animate")
            })
        })
    ...
    var A = 2,
        ...
        t = document.querySelector("#member-template").content.querySelector(".request__member");
    $(".request__form-member").on("click", function () {
        t.querySelector(".member-num").textContent = A < 10 ? "0" + A : A, $(".request__form-member").before(t.outerHTML), $(".request__form-member").prev().find('input[name="member-name"], input[name="member-role"]').on("focus", e), $(".request__form-member").prev().find(".member-delete").on("click", function () {
            $(this).parent().parent().remove(), A--, $(".member-num").each(function (A, e) {
                ++A < 10 ? $(e).text("0" + A) : $(e).text(A)
            })
        }), A++
    })
}), $(function () {
    var e, i, s, o, a, A, t, n, r;
    a = [], A = 0, t = function () {
        for (var A = i.createImageData(s, o), e = new Uint32Array(A.data.buffer), t = e.length, n = 0; n < t; n++) Math.random() < .5 && (e[n] = 4278190080);
        a.push(A)
    }, n = function () {
        9 === A ? A = 0 : A++, i.putImageData(a[A], 0, 0), window.setTimeout(function () {
            window.requestAnimationFrame(n)
        }, 40)
    }, r = function () {
        s = window.innerWidth, o = window.innerHeight, e.width = s, e.height = o;
        for (var A = 0; A < 10; A++) t();
        n()
    }, e = document.getElementById("noise"), i = e.getContext("2d"), r()
});